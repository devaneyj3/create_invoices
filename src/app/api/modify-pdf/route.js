...
export async function GET(request) {
  ...
  try {
    ...
    drawText("Full Stack Web Developer", 50, 120, 11, undefined, timesRomanItalic);
    ...
    drawText(`INVOICE#: 2025-${invoiceNum}`, 400, 160, 11, blue, timesRomanBold);
    drawText(`DATE: ${getCurrentDateFormatted()}`, 400, 175, 11, blue, timesRomanBold);
    ...
    drawText(`${getCurrentDateFormatted()}`, 300, 420, 12, undefined, timesRomanBold);
    drawText("1600.00", 500, 420, 12);
